...
| [NLP](nlp/) | Разработка модели, которая будет искать токсичные комментарии и отправлять их на модерацию | *pandas, numpy, torch, transformers, re, wordcloud, nltk, spacy, gensim, sklearn, optuna, time, tqdm, matplotlib, seaborn, warnings, os* |
